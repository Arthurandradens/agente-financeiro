  ...
  fastify.post(
    ...
    async (request, reply) => {
      try {
        ...
        const classificados = await classificationService.classifyCSV(
          csvContent,
          systemPrompt,
          bankId,
        );
        ...
        throw new HttpError(
          500,
          error.message || "Erro ao processar upload de CSV",
        );
      }
    },
  );
