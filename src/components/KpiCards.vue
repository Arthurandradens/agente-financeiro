<template>
  <div
    class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 mb-6"
  >
    <!-- Entradas -->
      ...
      <div class="card-content">
        <div class="flex items-center justify-between">
          ...
          <div class="p-3 bg-blue-100 dark:bg-blue-900/30 rounded-full">
            <i
              class="pi pi-credit-card text-blue-600 dark:text-blue-400 text-xl"
            ></i>
          </div>
        </div>
      ...
      <div class="card-content">
        <div class="flex items-center justify-between">
          ...
          <div class="p-3 bg-purple-100 dark:bg-purple-900/30 rounded-full">
            <i
              class="pi pi-chart-line text-purple-600 dark:text-purple-400 text-xl"
            ></i>
          </div>
        </div>
