  ...
  <div class="flex flex-col items-center justify-center min-h-[400px] p-8">
    <div class="text-center">
      ...
      <p class="text-gray-600 dark:text-gray-400 mb-6">
        Selecione um arquivo CSV para classificação automática ou um arquivo
        Excel (.xlsx) já classificado
      </p>
      ...
      >
        ...
        <div class="text-center">
          <i
            class="pi pi-cloud-upload text-4xl text-gray-400 dark:text-gray-500 mb-4"
          ></i>
      ...
      <div v-if="loading" class="mt-4 w-full max-w-md mx-auto">
        ...
        <div class="text-center">
          ...
          <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">
            {{
              fileType === "csv"
                ? "Processando e classificando arquivo..."
                : "Processando arquivo..."
            }}
          </p>
          <p
            v-if="fileType === 'csv' && uploadProgress > 0"
